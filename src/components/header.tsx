  ...
  const items = [
    {
      ...
      links: [
        ...
        { label: "Nossos Destaques", ariaLabel: "Ver produtos em destaque", href: "/#destaques" },
        { label: "Sobre Nós", ariaLabel: "Conheça a Baunilha e Flor de Sal", href: "/#sobre" }
      ]
    },
    {
      label: "Produtos", 
    ...
    },
    {
      ...
      textColor: "#000",
      links: [
        { label: "WhatsApp", ariaLabel: "Contato via WhatsApp", href: "https://wa.me/5511985668978" },
        { label: "Instagram", ariaLabel: "Seguir no Instagram", href: "https://instagram.com/baunilhaeflordesal" },
        { label: "Facebook", ariaLabel: "Curtir no Facebook", href: "https://facebook.com/baunilhaeflordesal" }
      ]
    }
  ];
